...
export const products: Product[] = [
  ...
  { id:"w3", name:"Royal Chronograph", brand:"Majestic Geneva", category:"watches", style:["bold","classic"], occasion:["special event","work"], price:320000, priceRange:"80k+", image:"https://images.unsplash.com/photo-1639037427455-b7be63d2b6d8?w=800&q=80", description:"Flyback chronograph, 18k gold case, blue sunray dial, exhibition caseback." },
  ...
  { id:"w11", name:"Sport Chronos Elite", brand:"Veloce Milano", category:"watches", style:["bold"], occasion:["everyday","work"], price:72000, priceRange:"30k-80k", image:"https://images.unsplash.com/photo-1548171916-c8fd5d56a0e8?w=800&q=80", description:"Tachymeter bezel, pushers at 2 and 4, bi-compax chronograph layout." },
  ...
  { id:"b4", name:"Micro Croco Clutch", brand:"Selva Nera", category:"bags", style:["bold","romantic"], occasion:["date night","special event"], price:14500, priceRange:"10k-30k", image:"https://images.unsplash.com/photo-1585386959984-a4155224a1ad?w=800&q=80", description:"Embossed crocodile leather, antique brass push-lock, wrist strap." },
  ...
  { id:"b7", name:"Box Bag Velvet", brand:"Obscura Maison", category:"bags", style:["bold","romantic"], occasion:["date night","special event"], price:32000, priceRange:"30k-80k", image:"https://images.unsplash.com/photo-1601924994987-69e26d50dc26?w=800&q=80", description:"Midnight velvet exterior, aged brass hardware, push-lock with charm." },
  ...
  { id:"b9", name:"Hobo Soft Nappa", brand:"Venezia Atelier", category:"bags", style:["romantic","minimalist"], occasion:["everyday","date night"], price:58000, priceRange:"30k-80k", image:"https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=800&q=80", description:"Supple nappa leather in a relaxed hobo silhouette, suede interior." },
  ...
  { id:"b11", name:"Mini Crossbody", brand:"Selva Nera", category:"bags", style:["minimalist","romantic"], occasion:["everyday","date night"], price:16000, priceRange:"10k-30k", image:"https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=800&q=80", description:"Compact pebbled leather, adjustable strap, two card slots inside." },
  { id:"b12", name:"Oversized Shopper", brand:"Maison Verdeau", category:"bags", style:["bold","classic"], occasion:["everyday"], price:125000, priceRange:"80k+", image:"https://images.unsplash.com/photo-1560243563-062bfc001d68?w=800&q=80", description:"Buttery soft nappa in oversized format, magnetic snap, unlined for lightness." },
  ...
  { id:"f3", name:"Rose Noir EDP", brand:"Lumière Paris", category:"fragrance", style:["romantic","classic"], occasion:["date night","special event"], price:24000, priceRange:"10k-30k", image:"https://images.unsplash.com/photo-1592945403244-b3fbafd7f539?w=800&q=80", description:"Centifolia rose absolute, dark patchouli, sandalwood base. A rose after dark." },
  { id:"f4", name:"Bergamot & Cedar", brand:"Jardin Blanc", category:"fragrance", style:["minimalist","classic"], occasion:["everyday","work"], price:6800, priceRange:"under-10k", image:"https://images.unsplash.com/photo-1563170351-be82bc888aa4?w=800&q=80", description:"Calabrian bergamot, Atlas cedarwood, dry vetiver. Clean confidence." },
  { id:"f5", name:"Suede Musc", brand:"Obscura Parfums", category:"fragrance", style:["romantic","minimalist"], occasion:["date night","everyday"], price:16500, priceRange:"10k-30k", image:"https://images.unsplash.com/photo-1594035910387-fea47794261f?w=800&q=80", description:"Suede accord, white musk, cashmere wood. Skin-close and intimate." },
  { id:"f6", name:"Tobacco Vert", brand:"Atelier Fume", category:"fragrance", style:["bold"], occasion:["special event","date night"], price:32000, priceRange:"30k-80k", image:"https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?w=800&q=80", description:"Green tobacco, saddle leather, dark oud. Unapologetic and rare." },
  { id:"f7", name:"Neroli Grandiflora", brand:"Côte d'Azur Studio", category:"fragrance", style:["romantic","minimalist"], occasion:["everyday","special event"], price:12000, priceRange:"10k-30k", image:"https://images.unsplash.com/photo-1600612253971-61a39647e1d8?w=800&q=80", description:"Tunisian neroli absolute, petitgrain, warm musk base. Mediterranean sunlight." },
  { id:"f8", name:"Amber Imperiale", brand:"Al Baraka Parfums", category:"fragrance", style:["bold","classic"], occasion:["special event","work"], price:42000, priceRange:"30k-80k", image:"https://images.unsplash.com/photo-1615634260167-c8cdede054de?w=800&q=80", description:"Labdanum amber, olibanum, aged patchouli. A resinous monument." },
  { id:"f9", name:"Violette Noir", brand:"Lumière Paris", category:"fragrance", style:["romantic","bold"], occasion:["date night","special event"], price:28000, priceRange:"10k-30k", image:"https://images.unsplash.com/photo-1590156562745-5d09f82db2be?w=800&q=80", description:"Parma violet, iris butter, dark plum accord. Velvet and intrigue." },
  { id:"f10", name:"Hinoki & Smoke", brand:"Atelier Fume", category:"fragrance", style:["minimalist","bold"], occasion:["everyday","work"], price:22000, priceRange:"10k-30k", image:"https://images.unsplash.com/photo-1608528577891-eb055944f2e7?w=800&q=80", description:"Japanese cypress, birch tar, white smoke accord. Meditative and grounding." },
  ...
  { id:"a6", name:"Wide-Leg Crepe Trousers", brand:"Studio Neutre", category:"apparel", style:["bold","minimalist"], occasion:["work","everyday"], price:26000, priceRange:"10k-30k", image:"https://images.unsplash.com/photo-1594938298603-c8148c4b4051?w=800&q=80", description:"Fluid acetate crepe, high-rise waist, wide-leg silhouette, invisible zip." },
  { id:"a7", name:"Tuxedo Smoking Jacket", brand:"Maison Forêt", category:"apparel", style:["bold","classic"], occasion:["special event"], price:220000, priceRange:"80k+", image:"https://images.unsplash.com/photo-1598808503246-56c89e1a8f14?w=800&q=80", description:"Midnight navy wool-silk, satin peak lapels, jetted pockets, full canvas." },
  ...
  { id:"a12", name:"Double-Breasted Suit", brand:"Sartoria Bianco", category:"apparel", style:["bold","classic"], occasion:["work","special event"], price:165000, priceRange:"80k+", image:"https://images.unsplash.com/photo-1594938374182-a57369b25390?w=800&q=80", description:"Super 120s wool, peak lapels, 6x2 button stance, full brace buttons." },
];
